	...
	var menubar = {
		...
		listenForEvents: function listenForEvents() {
			...
			$(window).on('load', function (e) {
				...
				if (app.topbarLayout && current.name !== 'xs') $(document).on('app-menu.reduce.done', self.highlightOpenLink.bind(self));else self.highlightOpenLink();
		...
		foldAppUser: function foldAppUser() {
		...
		reduceAppMenu: function reduceAppMenu() {
		...
		toggleSubmenuOnClick: function toggleSubmenuOnClick(e) {
			$(this).parent().toggleClass('open').find('> .submenu').slideToggle(500).end().siblings().removeClass('open').find('> .submenu').slideUp(500);
			e.preventDefault();
		},

		toggleTopbarSubmneuOnHover: function toggleTopbarSubmneuOnHover(e) {
			var $this = $(this),
		...
		readjustScroll: function readjustScroll(e) {
		...
		toggleMenuHeading: function toggleMenuHeading() {
		...
		highlightOpenLink: function highlightOpenLink() {
		...
		getAppliedTheme: function getAppliedTheme() {
			var appliedTheme = "",
		...
		applyTheme: function applyTheme() {
			$body.removeClass('menubar-' + this.getAppliedTheme()).addClass('menubar-' + this.getCurrentTheme());
			$menubar.removeClass(this.getAppliedTheme()).addClass(this.getCurrentTheme());
		}
	};
...
+function ($, window) {
	...
	var customizer = {
		...
		initCustomizer: function initCustomizer() {
		...
		setMenubarTheme: function setMenubarTheme() {
			var $this = $(this);
		...
		setNavbarTheme: function setNavbarTheme(e) {
			var $this = $(this);
		...
		toggleMenubarFold: function toggleMenubarFold() {
			if ($(this).is(':checked')) {
		...
		resetSettings: function resetSettings(e) {
			app.settings = app.defaults;
			app.saveSettings();
			location.reload();
		},

		renderNavbarThemeChoices: function renderNavbarThemeChoices() {
			var html = '';
		...
		getTemplate: function getTemplate(themeName) {
...
function removeTheme(themeName) {
	...
	if (index !== -1 && themeName !== 'primary') {
		...
		if (themeName === app.settings.navbar.theme) app.settings.navbar.theme = 'primary';
...
throw new Error("Module build failed: ModuleBuildError: Module build failed: Error: ENOENT: no such file or directory, open '/Users/a1/Projects/Freelance/Tmchannel.ru/website/node_modules/css-loader/lib/css-base.js'\n    at runLoaders (/Users/a1/Projects/Freelance/Tmchannel.ru/website/node_modules/webpack/lib/NormalModule.js:195:19)\n    at /Users/a1/Projects/Freelance/Tmchannel.ru/website/node_modules/loader-runner/lib/LoaderRunner.js:364:11\n    at /Users/a1/Projects/Freelance/Tmchannel.ru/website/node_modules/loader-runner/lib/LoaderRunner.js:200:19\n    at /Users/a1/Projects/Freelance/Tmchannel.ru/website/node_modules/enhanced-resolve/lib/CachedInputFileSystem.js:70:14\n    at _combinedTickCallback (internal/process/next_tick.js:131:7)\n    at process._tickCallback (internal/process/next_tick.js:180:9)");
